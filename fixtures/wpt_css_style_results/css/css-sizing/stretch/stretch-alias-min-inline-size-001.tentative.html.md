# css/css-sizing/stretch/stretch-alias-min-inline-size-001.tentative.html

```json
{
  "format_version": 3,
  "file": "css/css-sizing/stretch/stretch-alias-min-inline-size-001.tentative.html"
}
```
...
```css
  ...
  .test {
    ...
    /* We expect "min-inline-size:stretch" to cause the used value of
