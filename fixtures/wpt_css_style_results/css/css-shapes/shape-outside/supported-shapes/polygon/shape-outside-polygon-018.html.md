# css/css-shapes/shape-outside/supported-shapes/polygon/shape-outside-polygon-018.html

```json
{
  "format_version": 3,
  "file": "css/css-shapes/shape-outside/supported-shapes/polygon/shape-outside-polygon-018.html"
}
```
