# css/css-shapes/shape-outside/supported-shapes/ellipse/shape-outside-ellipse-047.html

```json
{
  "format_version": 3,
  "file": "css/css-shapes/shape-outside/supported-shapes/ellipse/shape-outside-ellipse-047.html"
}
```
