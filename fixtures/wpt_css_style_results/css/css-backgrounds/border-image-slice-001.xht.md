# css/css-backgrounds/border-image-slice-001.xht

```json
{
  "format_version": 3,
  "file": "css/css-backgrounds/border-image-slice-001.xht"
}
```
...
<![CDATA[
  ...
  border-image-slice: 5% 10% 15% 20%; /* or 5 10 15 20 : see border-image-slice-002 test */
