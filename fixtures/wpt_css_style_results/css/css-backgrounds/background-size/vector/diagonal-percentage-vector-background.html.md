# css/css-backgrounds/background-size/vector/diagonal-percentage-vector-background.html

```json
{
  "format_version": 3,
  "file": "css/css-backgrounds/background-size/vector/diagonal-percentage-vector-background.html"
}
```
