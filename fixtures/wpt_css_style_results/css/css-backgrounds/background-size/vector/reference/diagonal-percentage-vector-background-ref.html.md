# css/css-backgrounds/background-size/vector/reference/diagonal-percentage-vector-background-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-backgrounds/background-size/vector/reference/diagonal-percentage-vector-background-ref.html"
}
```
