# css/css-backgrounds/animations/background-color-animation-fallback-replace.html

```json
{
  "format_version": 3,
  "file": "css/css-backgrounds/animations/background-color-animation-fallback-replace.html"
}
```
