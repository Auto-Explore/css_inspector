# css/css-gaps/grid/fragmentation/grid-gap-decorations-fragmentation-024.html

```json
{
  "format_version": 3,
  "file": "css/css-gaps/grid/fragmentation/grid-gap-decorations-fragmentation-024.html"
}
```
