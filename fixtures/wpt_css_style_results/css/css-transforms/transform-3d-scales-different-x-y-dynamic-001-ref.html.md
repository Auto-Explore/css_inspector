# css/css-transforms/transform-3d-scales-different-x-y-dynamic-001-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-transforms/transform-3d-scales-different-x-y-dynamic-001-ref.html"
}
```
