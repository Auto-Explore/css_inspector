# css/css-borders/tentative/border-shape/border-shape-half-border-box-default-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-borders/tentative/border-shape/border-shape-half-border-box-default-ref.html"
}
```
