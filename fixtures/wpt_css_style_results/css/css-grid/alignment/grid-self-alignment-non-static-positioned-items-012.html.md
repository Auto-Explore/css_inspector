# css/css-grid/alignment/grid-self-alignment-non-static-positioned-items-012.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/alignment/grid-self-alignment-non-static-positioned-items-012.html"
}
```
