# css/css-grid/alignment/grid-self-alignment-positioned-items-with-margin-border-padding-013.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/alignment/grid-self-alignment-positioned-items-with-margin-border-padding-013.html"
}
```
