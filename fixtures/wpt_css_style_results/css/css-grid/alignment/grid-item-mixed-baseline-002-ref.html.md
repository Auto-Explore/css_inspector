# css/css-grid/alignment/grid-item-mixed-baseline-002-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/alignment/grid-item-mixed-baseline-002-ref.html"
}
```
...
```json
{
  ...
  "messages": [
    ...
    {
      "message": "Invalid value for property “place-self”.",
      "severity": "Error"
    },
    {
      "message": "Invalid value for property “place-self”.",
