# css/css-grid/alignment/grid-column-axis-alignment-positioned-items-016.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/alignment/grid-column-axis-alignment-positioned-items-016.html"
}
```
