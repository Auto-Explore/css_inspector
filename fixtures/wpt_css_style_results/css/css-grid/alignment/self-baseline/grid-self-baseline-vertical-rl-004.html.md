# css/css-grid/alignment/self-baseline/grid-self-baseline-vertical-rl-004.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/alignment/self-baseline/grid-self-baseline-vertical-rl-004.html"
}
```
