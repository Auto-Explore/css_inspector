# css/css-grid/layout-algorithm/grid-automatic-minimum-for-auto-columns-001.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/layout-algorithm/grid-automatic-minimum-for-auto-columns-001.html"
}
```
