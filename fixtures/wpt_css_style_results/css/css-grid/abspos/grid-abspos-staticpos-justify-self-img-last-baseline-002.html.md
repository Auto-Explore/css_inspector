# css/css-grid/abspos/grid-abspos-staticpos-justify-self-img-last-baseline-002.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/abspos/grid-abspos-staticpos-justify-self-img-last-baseline-002.html"
}
```
