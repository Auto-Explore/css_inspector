# css/css-grid/abspos/grid-abspos-staticpos-justify-self-vertWM-004-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/abspos/grid-abspos-staticpos-justify-self-vertWM-004-ref.html"
}
```
