# css/css-grid/abspos/grid-abspos-staticpos-justify-self-rtl-last-baseline-004.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/abspos/grid-abspos-staticpos-justify-self-rtl-last-baseline-004.html"
}
```
