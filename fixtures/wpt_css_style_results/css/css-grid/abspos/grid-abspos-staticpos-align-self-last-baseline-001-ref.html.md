# css/css-grid/abspos/grid-abspos-staticpos-align-self-last-baseline-001-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/abspos/grid-abspos-staticpos-align-self-last-baseline-001-ref.html"
}
```
