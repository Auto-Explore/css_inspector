# css/css-grid/abspos/grid-abspos-staticpos-align-self-rtl-last-baseline-002-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/abspos/grid-abspos-staticpos-align-self-rtl-last-baseline-002-ref.html"
}
```
