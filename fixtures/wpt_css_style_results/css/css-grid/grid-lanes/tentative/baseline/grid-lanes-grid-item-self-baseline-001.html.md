# css/css-grid/grid-lanes/tentative/baseline/grid-lanes-grid-item-self-baseline-001.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/baseline/grid-lanes-grid-item-self-baseline-001.html"
}
```
