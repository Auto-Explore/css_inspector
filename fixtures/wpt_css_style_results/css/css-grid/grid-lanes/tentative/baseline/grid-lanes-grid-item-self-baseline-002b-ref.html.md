# css/css-grid/grid-lanes/tentative/baseline/grid-lanes-grid-item-self-baseline-002b-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/baseline/grid-lanes-grid-item-self-baseline-002b-ref.html"
}
```
