# css/css-grid/grid-lanes/tentative/subgrid/column/grid-lanes-subgrid-002a.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/subgrid/column/grid-lanes-subgrid-002a.html"
}
```
