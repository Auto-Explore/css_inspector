# css/css-grid/grid-lanes/tentative/subgrid/column/grid-lanes-subgrid-002e.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/subgrid/column/grid-lanes-subgrid-002e.html"
}
```
