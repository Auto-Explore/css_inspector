# css/css-grid/grid-lanes/tentative/subgrid/row/grid-lanes-subgrid-001a.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/subgrid/row/grid-lanes-subgrid-001a.html"
}
```
