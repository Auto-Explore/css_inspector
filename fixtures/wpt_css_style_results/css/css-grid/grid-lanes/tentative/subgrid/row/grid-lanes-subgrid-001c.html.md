# css/css-grid/grid-lanes/tentative/subgrid/row/grid-lanes-subgrid-001c.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/subgrid/row/grid-lanes-subgrid-001c.html"
}
```
