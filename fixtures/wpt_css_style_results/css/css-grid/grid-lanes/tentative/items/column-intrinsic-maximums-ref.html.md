# css/css-grid/grid-lanes/tentative/items/column-intrinsic-maximums-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/items/column-intrinsic-maximums-ref.html"
}
```
