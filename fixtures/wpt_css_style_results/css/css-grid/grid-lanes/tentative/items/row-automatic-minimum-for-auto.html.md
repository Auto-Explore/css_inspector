# css/css-grid/grid-lanes/tentative/items/row-automatic-minimum-for-auto.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/items/row-automatic-minimum-for-auto.html"
}
```
