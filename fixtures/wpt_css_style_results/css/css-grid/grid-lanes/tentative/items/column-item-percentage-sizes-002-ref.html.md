# css/css-grid/grid-lanes/tentative/items/column-item-percentage-sizes-002-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/items/column-item-percentage-sizes-002-ref.html"
}
```
