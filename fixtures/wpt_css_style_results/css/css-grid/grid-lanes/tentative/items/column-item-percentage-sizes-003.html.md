# css/css-grid/grid-lanes/tentative/items/column-item-percentage-sizes-003.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/items/column-item-percentage-sizes-003.html"
}
```
