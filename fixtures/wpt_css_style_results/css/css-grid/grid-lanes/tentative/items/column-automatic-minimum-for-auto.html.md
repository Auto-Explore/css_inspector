# css/css-grid/grid-lanes/tentative/items/column-automatic-minimum-for-auto.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/items/column-automatic-minimum-for-auto.html"
}
```
...
.grid-lanes { display: grid-lanes; font: 10px/1 Ahem; }
