# css/css-grid/grid-lanes/tentative/items/column-item-percentage-sizes-003-ref.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/items/column-item-percentage-sizes-003-ref.html"
}
```
...
.min {
  min-height: calc(2px + 10px);
  min-width: calc(2px + 100%);
}
.max {
  max-height: calc(2px + 10px);
  max-width: calc(2px + 100%);
}
.size {
  height: calc(2px + 10px);
  width: calc(2px + 100%);
}
...
.hl, .hr, .vrl, .vrr, .vll, .vlr, .sll, .slr { margin-bottom: 3px; }
