# css/css-grid/grid-lanes/tentative/items/row-item-percentage-sizes-002.html

```json
{
  "format_version": 3,
  "file": "css/css-grid/grid-lanes/tentative/items/row-item-percentage-sizes-002.html"
}
```
