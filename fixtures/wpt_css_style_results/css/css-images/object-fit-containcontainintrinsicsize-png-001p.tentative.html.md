# css/css-images/object-fit-containcontainintrinsicsize-png-001p.tentative.html

```json
{
  "format_version": 3,
  "file": "css/css-images/object-fit-containcontainintrinsicsize-png-001p.tentative.html"
}
```
