# css/css-inline/initial-letter/initial-letter-block-position-drop-over-ruby.html

```json
{
  "format_version": 3,
  "file": "css/css-inline/initial-letter/initial-letter-block-position-drop-over-ruby.html"
}
```
